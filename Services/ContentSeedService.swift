...
struct ContentSeedService {
    ...
    private func seedSessions(context: ModelContext) throws {
        ...
        for session in Self.sessions where !existingSessions.contains(session.stableKey) {
            context.insert(Session(stableKey: session.stableKey, trackStableKey: session.trackStableKey, titleKey: session.titleKey, level: session.level, isPro: session.isPro, tags: session.tags))
        }
        ...
        if !existingSessions.contains("two_min_reset") {
            context.insert(Session(stableKey: "two_min_reset", trackStableKey: "stress", titleKey: "session.two_min_reset.title", level: "beginner", baseDurationMinutes: 2, isPro: false, tags: ["2min", "free", "lowImpact", "noFloor"]))
        }
    }
    ...
    static let sessions: [SeedSession] = [
        .init(stableKey: "office_session_1", trackStableKey: "office", titleKey: "session.office_session_1.title", level: "beginner", isPro: false, tags: ["free", "starter", "noFloor", "lowImpact"], exerciseKeys: ["office_chin_tuck","office_neck_rotation","office_scap_squeeze","office_doorway_pec"]),
        .init(stableKey: "office_session_2", trackStableKey: "office", titleKey: "session.office_session_2.title", level: "beginner", isPro: false, tags: ["free", "starter", "lowImpact"], exerciseKeys: ["office_cat_cow","office_thread_needle","office_wall_angel","office_wrist_extensor"]),
        .init(stableKey: "office_session_3", trackStableKey: "office", titleKey: "session.office_session_3.title", level: "beginner", isPro: false, tags: ["free", "starter", "noFloor", "lowImpact"], exerciseKeys: ["office_levator_stretch","office_neck_side_bend","office_scap_squeeze","stress_box_breathing"]),
        .init(stableKey: "office_session_4", trackStableKey: "office", titleKey: "session.office_session_4.title", level: "intermediate", isPro: true, tags: ["pro", "desk", "noFloor"], exerciseKeys: ["office_wall_angel","office_thread_needle","run_tibialis_raises","office_doorway_pec"]),
        .init(stableKey: "office_session_5", trackStableKey: "office", titleKey: "session.office_session_5.title", level: "intermediate", isPro: true, tags: ["pro", "desk", "lowImpact"], exerciseKeys: ["office_cat_cow","mob_spine_twist","office_wrist_extensor","stress_body_scan"]),

        .init(stableKey: "running_session_1", trackStableKey: "running", titleKey: "session.running_session_1.title", level: "beginner", isPro: false, tags: ["free", "starter", "noFloor", "lowImpact"], exerciseKeys: ["run_single_leg_balance","run_tibialis_raises","run_ankle_mobility","run_calf_eccentric"]),
        .init(stableKey: "running_session_2", trackStableKey: "running", titleKey: "session.running_session_2.title", level: "beginner", isPro: false, tags: ["free", "starter", "noFloor"], exerciseKeys: ["run_split_squat","run_step_down","run_single_leg_rdl","run_lateral_band_walk"]),
        .init(stableKey: "running_session_3", trackStableKey: "running", titleKey: "session.running_session_3.title", level: "beginner", isPro: false, tags: ["free", "starter", "lowImpact"], exerciseKeys: ["run_clamshell","run_ankle_mobility","parent_calf_raises","stress_box_breathing"]),
        .init(stableKey: "running_session_4", trackStableKey: "running", titleKey: "session.running_session_4.title", level: "intermediate", isPro: true, tags: ["pro", "noFloor"], exerciseKeys: ["run_split_squat","run_single_leg_rdl","run_step_down","run_tibialis_raises"]),
        .init(stableKey: "running_session_5", trackStableKey: "running", titleKey: "session.running_session_5.title", level: "intermediate", isPro: true, tags: ["pro", "lowImpact"], exerciseKeys: ["run_calf_eccentric","run_ankle_mobility","mob_hamstring","stress_body_scan"]),

        .init(stableKey: "parents_session_1", trackStableKey: "parents", titleKey: "session.parents_session_1.title", level: "beginner", isPro: false, tags: ["free", "starter", "noFloor", "lowImpact"], exerciseKeys: ["parent_march_in_place","parent_sit_to_stand","parent_counter_pushup","parent_breath_reset"]),
        .init(stableKey: "parents_session_2", trackStableKey: "parents", titleKey: "session.parents_session_2.title", level: "beginner", isPro: false, tags: ["free", "starter", "lowImpact"], exerciseKeys: ["parent_glute_bridge","parent_dead_bug","parent_side_plank_knees","parent_hip_flexor_stretch"]),
        .init(stableKey: "parents_session_3", trackStableKey: "parents", titleKey: "session.parents_session_3.title", level: "beginner", isPro: false, tags: ["free", "starter", "noFloor", "lowImpact"], exerciseKeys: ["parent_march_in_place","parent_calf_raises","stress_shoulder_rolls","stress_box_breathing"]),
        .init(stableKey: "parents_session_4", trackStableKey: "parents", titleKey: "session.parents_session_4.title", level: "intermediate", isPro: true, tags: ["pro", "noFloor"], exerciseKeys: ["parent_sit_to_stand","parent_counter_pushup","run_split_squat","parent_calf_raises"]),
        .init(stableKey: "parents_session_5", trackStableKey: "parents", titleKey: "session.parents_session_5.title", level: "intermediate", isPro: true, tags: ["pro", "lowImpact"], exerciseKeys: ["parent_glute_bridge","parent_dead_bug","parent_hip_flexor_stretch","stress_body_scan"]),

        .init(stableKey: "stress_session_1", trackStableKey: "stress", titleKey: "session.stress_session_1.title", level: "beginner", isPro: false, tags: ["free", "starter", "noFloor", "lowImpact"], exerciseKeys: ["stress_box_breathing","stress_shoulder_rolls","stress_neck_release","parent_breath_reset"]),
        .init(stableKey: "stress_session_2", trackStableKey: "stress", titleKey: "session.stress_session_2.title", level: "beginner", isPro: false, tags: ["free", "starter", "lowImpact"], exerciseKeys: ["stress_body_scan","stress_child_pose","mob_spine_twist","stress_forward_fold"]),
        .init(stableKey: "stress_session_3", trackStableKey: "stress", titleKey: "session.stress_session_3.title", level: "beginner", isPro: false, tags: ["free", "starter", "noFloor", "lowImpact"], exerciseKeys: ["stress_box_breathing","office_neck_rotation","stress_shoulder_rolls","stress_body_scan"]),
        .init(stableKey: "stress_session_4", trackStableKey: "stress", titleKey: "session.stress_session_4.title", level: "intermediate", isPro: true, tags: ["pro", "lowImpact"], exerciseKeys: ["stress_body_scan","stress_child_pose","stress_forward_fold","mob_90_90"]),
        .init(stableKey: "stress_session_5", trackStableKey: "stress", titleKey: "session.stress_session_5.title", level: "intermediate", isPro: true, tags: ["pro", "noFloor", "lowImpact"], exerciseKeys: ["stress_box_breathing","parent_breath_reset","stress_neck_release","stress_shoulder_rolls"]),

        .init(stableKey: "mobility_session_1", trackStableKey: "mobility", titleKey: "session.mobility_session_1.title", level: "beginner", isPro: false, tags: ["free", "starter", "lowImpact"], exerciseKeys: ["mob_worlds_greatest","mob_90_90","mob_hamstring","mob_spine_twist"]),
        .init(stableKey: "mobility_session_2", trackStableKey: "mobility", titleKey: "session.mobility_session_2.title", level: "beginner", isPro: false, tags: ["free", "starter", "lowImpact", "noFloor"], exerciseKeys: ["run_ankle_mobility","office_wall_angel","office_doorway_pec","stress_box_breathing"]),
        .init(stableKey: "mobility_session_3", trackStableKey: "mobility", titleKey: "session.mobility_session_3.title", level: "beginner", isPro: false, tags: ["free", "starter", "lowImpact"], exerciseKeys: ["mob_glute_piriformis","mob_hamstring","mob_couch_stretch","stress_child_pose"]),
        .init(stableKey: "mobility_session_4", trackStableKey: "mobility", titleKey: "session.mobility_session_4.title", level: "intermediate", isPro: true, tags: ["pro", "lowImpact"], exerciseKeys: ["mob_worlds_greatest","mob_90_90","mob_couch_stretch","run_single_leg_rdl"]),
        .init(stableKey: "mobility_session_5", trackStableKey: "mobility", titleKey: "session.mobility_session_5.title", level: "intermediate", isPro: true, tags: ["pro", "noFloor", "lowImpact"], exerciseKeys: ["office_neck_side_bend","office_wrist_extensor","run_ankle_mobility","stress_body_scan"]),

        .init(stableKey: "strength_session_1", trackStableKey: "strength", titleKey: "session.strength_session_1.title", level: "beginner", isPro: false, tags: ["free", "starter", "noFloor", "lowImpact"], exerciseKeys: ["parent_sit_to_stand","parent_counter_pushup","parent_calf_raises","run_single_leg_balance"]),
        .init(stableKey: "strength_session_2", trackStableKey: "strength", titleKey: "session.strength_session_2.title", level: "beginner", isPro: false, tags: ["free", "starter", "lowImpact"], exerciseKeys: ["parent_glute_bridge","parent_dead_bug","parent_side_plank_knees","run_clamshell"]),
        .init(stableKey: "strength_session_3", trackStableKey: "strength", titleKey: "session.strength_session_3.title", level: "beginner", isPro: false, tags: ["free", "starter", "noFloor", "lowImpact"], exerciseKeys: ["run_tibialis_raises","parent_march_in_place","office_scap_squeeze","stress_box_breathing"]),
        .init(stableKey: "strength_session_4", trackStableKey: "strength", titleKey: "session.strength_session_4.title", level: "intermediate", isPro: true, tags: ["pro", "noFloor"], exerciseKeys: ["run_split_squat","run_lateral_band_walk","run_step_down","parent_counter_pushup"]),
        .init(stableKey: "strength_session_5", trackStableKey: "strength", titleKey: "session.strength_session_5.title", level: "intermediate", isPro: true, tags: ["pro", "lowImpact"], exerciseKeys: ["parent_glute_bridge","run_calf_eccentric","mob_hamstring","stress_body_scan"])
    ]
}
