...
@Model final class Exercise { @Attribute(.unique) var stableKey: String; var id: UUID; var nameKey: String; var descriptionKey: String; var baseDurationSeconds: Int; var tipsKey: String; var iconName: String
    init(id: UUID = UUID(), stableKey: String, nameKey: String, descriptionKey: String, baseDurationSeconds: Int, tipsKey: String, iconName: String) { self.id = id; self.stableKey = stableKey; self.nameKey = nameKey; self.descriptionKey = descriptionKey; self.baseDurationSeconds = baseDurationSeconds; self.tipsKey = tipsKey; self.iconName = iconName }
}
